...
(8, 'junior developer', 5, ' developer required', 90, '', '2019-11-27', '2019-11-21', '0000-00-00', 6);
...
(1, 'lajfk', 'jlkasjfk', '2343287`', 'asjkfj');
...
--
ALTER TABLE `projects`
  MODIFY `prj_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
