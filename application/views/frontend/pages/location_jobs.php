				...
				<div class="container">
						...
						<div class="col-lg-12 m-b30 clearfix">
							<div class="job-bx bg-white">
								<div class="job-bx-title clearfix">
									<h6 class="font-weight-700 pull-left text-uppercase">Browse Jobs by Top Locations</h6>
								</div>
								<div class="row">
					...
					<div id="masonry" class="row">
						<div class="card-container clearfix col-lg-3 col-sm-6 m-b30">
							<div class="job-bx bg-white">
								<div class="job-bx-title clearfix">
									<h6 class="font-weight-700 pull-left m-b0 font-13 text-uppercase">Jobs In London</h6>
								</div>
								<ul class="category-list">
									<li><a href="javascript:void(0);">Email Marketing</a></li>
									<li><a href="javascript:void(0);">Lead Generation</a></li>
